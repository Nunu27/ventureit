...
import 'package:ventureit/models/business.dart';
...
class Submission {
  ...
  @override
  String toString() {
    return 'Submission(id: $id, name: $name, location: $location, cover: $cover, pictures: $pictures, priceRange: $priceRange, description: $description, category: $category, openHours: $openHours, menu: $menu, externalLinks: $externalLinks, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
